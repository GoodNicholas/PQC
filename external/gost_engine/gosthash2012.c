...
# ifndef __i386__
    ...
    _mm_empty();
# endif
#elif defined(__GOST3411_HAS_NEON__)
    /* ARM NEON version - same logic as SSE2 */
    uint8x16_t v0, v2, v4, v6; /* First quadruple */
    uint8x16_t v1, v3, v5, v7; /* Second quadruple */
    unsigned int i;

    LOAD(N, v0, v2, v4, v6);
    XLPS128M(h, v0, v2, v4, v6);

    ULOAD(m, v1, v3, v5, v7);
    XLPS128R(v0, v2, v4, v6, v1, v3, v5, v7);

    for (i = 0; i < 11; i++)
        ROUND128(i, v0, v2, v4, v6, v1, v3, v5, v7);

    XLPS128M((&C[11]), v0, v2, v4, v6);
    X128R(v0, v2, v4, v6, v1, v3, v5, v7);
    ...
    STORE(h, v0, v2, v4, v6);
    /* No need for _mm_empty() on ARM NEON */
#else
